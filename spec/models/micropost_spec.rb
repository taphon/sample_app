  ...
  describe "validations" do
    ...
    describe "from_users_followed_by" do
      before(:each) do
        ...
        @user_post = @user.microposts.create!(:content => "power")
        @other_post = @other_user.microposts.create!(:content => "light")
        @third_post = @third_user.microposts.create!(:content => "electron")
      ...
      it "should not include a unfollowed user's micropost" do
        Micropost.from_users_followed_by(@user).
